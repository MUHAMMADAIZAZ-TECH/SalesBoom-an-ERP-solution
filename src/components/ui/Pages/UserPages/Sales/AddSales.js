...
function AddSales(props) {
    function getStyles(name, personName, theme) {
      ...
      const {
        ...
        }, [reload,SalesInvoice,customersList,Inv_key]);
    return (
      <>
       ...
       <Container maxWidth="lg" className={classes.container}>
        ...
        <Typography variant="h6" component="h6" color="secondary">Add Sales</Typography> 
        <Grid container spacing={2}>
            <Grid item xs={12} sm={3}>
            <div className={classes.root}>
              <FormControl>
              <InputLabel required id="Customers">Customer</InputLabel>
