    ...
    return (
        <>
          <Container maxWidth="lg" className={classes.container}>
            <Typography variant="h6" component="h6" color="secondary">Add Suplier</Typography> 
            <Grid container spacing={2}>
                ...
                <Grid item xs={12} sm={3}>
                  <Button variant="contained" color="secondary" onClick={handleClick}>Add Suplier</Button>
                </Grid>
                </Grid>
            </Container>
