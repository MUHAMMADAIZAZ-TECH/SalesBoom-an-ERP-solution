...
const EditPurchase = () => {
  ...
  function getStyles(name, personName, theme) {
    ...
    const handleChange = (evt) => {
        ...
        var SuplierList = [...Supliers]
        var SuplierIndex = SuplierList.findIndex(x => x.Name === value);
        const SuplierObj = Supliers[SuplierIndex]
        if(SuplierIndex === -1){
        ...
        setState({
          ...state,
          Name: SuplierObj.Name,
          Email: SuplierObj.Email,
          Phone: SuplierObj.Phone,
          Address: SuplierObj.Address,
          PreviousBalance: SuplierObj.PreviousBalance,
        })
    ...
    return (
        ...
        <Container maxWidth="lg" className={classes.container}>
          <Button color="primary" size="small" onClick={()=>{setOpenPdf(false)}} component={Link} to={"/dashboard/ManagePurchases"}>
        <FlipToFrontIcon />
        </Button>
        <div style={{ 
          display:"flex",
        ...
        <Grid container spacing={2}>
            ...
            <div className={classes.root}>
              <FormControl>
              <InputLabel id="Supliers">Supliers</InputLabel>
              <Select labelId="Supliers"
                    id="Supliers"
                    value={state.Name}
                    name="Name"
                    input={<Input />}
